...
function getLinks(txt) {
  ...
  $.get("//www.sefaria.org.il/api/links/" + txt).done(function (data) {
    ...
    var html = "<span id='sefaria-extension-output'><div id='sef-sidebar-ext-btn2'></div><div id='sef-sidebar-ext' ><div class='logowrap'><div id='sef-sidebar-ext-btn'></div></div><ol>";
